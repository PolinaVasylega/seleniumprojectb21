...
public class JSExecutorPractices {
    ...
    @Test
    public void fill_from_using_jsexecutor(){
    ...
    public void opening_tabs_using_jsExecutor(){
        ...
        ((JavascriptExecutor)Driver.getDriver()).executeScript("window.open('https://etsy.com','_black');");
        ((JavascriptExecutor)Driver.getDriver()).executeScript("window.open('https://facebook.com','_black');");
